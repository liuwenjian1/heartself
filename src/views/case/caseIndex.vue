    ...
    <el-row>
      <div class="app-container">
        ...
        >
          ...
          <el-table-column label="案例类型" :lg="2">
            <template slot-scope="scope">
              {{ scope.row.customerType}}
            </template>
          </el-table-column>
          <el-table-column label="公司名称" :lg="2">
            <template slot-scope="scope">
              {{ scope.row.companyName}}
            </template>
          </el-table-column>
          <el-table-column label="完成日期" :lg="2" align="center">
            <template slot-scope="scope">
              <span>{{ scope.row.completionTime }}</span>
            </template>
          </el-table-column>
          <el-table-column label="项目负责人" :lg="2" align="center">
            <template slot-scope="scope">
...
import { countCaseByType } from '@/api/case'
import { countCaseByMonth } from '@/api/case'
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      countCaseByType().then(response => {
        this.pieList = response.data
        this.getPie()
      })
      countCaseByMonth().then(response => {
